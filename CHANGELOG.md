...
### Added:
- Experimental support for R commands via local server. Snakemaker listens for R commands on a specific port.

### Changed:
- JSON output replaced by Markdown outputs in some prompts, improving performances especially for smaller LLMs.
- Improved support for Github Copilot APIs.
- Bug fixes.
